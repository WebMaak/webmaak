...
const CaseStudiesMedia = dynamic(() => import("./CaseStudiesMedia"), { ssr: false });
...
function SecondSection() {
  ...
  return (
    <>
    <div className="section_home-case-studies" id="section3" data-theme="light">
        ...
        <div className="container-large">
          <div className="padding-section-large-second-section">
              ...
              <div className="section-info-wrap case-study">
                ...
                <div className="fadeup">
                  <p split-text="true" className="sub-title">
                    Explore how we’ve turned ideas into digital experiences that elevate brands and drive growth
                  </p>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              `}
              style={{
                transform: active === "map" ? "translateX(147px)" : "translateX(0px)",
              }}
            ></div>
            ...
            <button
              ...
              className={`relative z-10 px-9 py-3 rounded-full text-base font-semibold transition-colors duration-300 ${
          ...
          <div className={`${ active === "table" ? "hidden" : "visible" }`} style={{ transition: "visibility 0.3s ease-in-out", width: "100%" }}>
            <CaseStudiesMedia />
          </div>
          <div className={`${ active === "map" ? "hidden" : "visible" }`} style={{ transition: "visibility 0.3s ease-in-out", width: "100%" }}>
            <CaseStudiesIt />
          </div>
