...
import styles from "./WorkSuspensionPage.module.css";
...
export default function WorkSuspensionPage() {
  return (
    <div className={styles.container}>
      ...
      <h2 className={styles.sectionHeading}>2. When Work May Be Suspended</h2>
      ...
      <h2 className={styles.sectionHeading}>3. During Suspension</h2>
      ...
      <h2 className={styles.sectionHeading}>4. Resuming Work</h2>
      ...
      <h2 className={styles.sectionHeading}>5. Data Retention</h2>
      ...
      <h2 className={styles.sectionHeading}>7. Agreement & Enforcement</h2>
      <p className={styles.paragraph}>
        By engaging WebMaak's services, the client{" "}
        <span className="font-bold">acknowledges and agrees</span> to this{" "}
        <span className="font-bold">Work Suspension Policy</span>, ensuring
        <span className="font-bold"> timely collaboration </span> and
        <span className="font-bold"> structured project management.</span>
      </p>
