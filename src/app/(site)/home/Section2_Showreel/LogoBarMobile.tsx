...
import "@/styles/showreel/LogoBarMobile.css";
...
const LogoBarMobile: React.FC<LogoBarMobileProps> = ({
  ...
  // Optimize logo URL
  const optimizedLogo = activeProject.logo.includes("cloudinary.com")
    ? activeProject.logo.replace("/upload/", "/upload/w_200,f_auto,q_auto/")
    : activeProject.logo;
        ...
        <div className="mobile-logo-center">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="mobile-brand-logo-container"
            >
              <Image
