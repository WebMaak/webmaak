...
export async function POST(req: Request) {
  try {
    ...
    const mailOptions = {
      from: `"WebMaak Leads" <${process.env.GMAIL_USER}>`,
      to: process.env.MAIL_TO,
      subject: `New Lead: ${fullName} - ${serviceString}`,
      html: `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; border: 1px solid #eee; padding: 20px; border-radius: 10px;">
          ...
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
              ...
              <td style="padding: 10px; border-bottom: 1px solid #eee;">${serviceString}</td>
            </tr>
          </table>
          ...
          <p style="margin-top: 30px; font-size: 12px; color: #666;">Generated by WebMaak Lead Management System</p>
        </div>
      `,
    };
