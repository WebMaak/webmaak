            ...
            <div className="section-info-wrap">
              ...
              <div className="fadeup">
                <p className="sub-title-border-about background-color-white ">
                  ...
                  <span className="font-semibold"> WebMaak Creative LLP </span>
              ...
              <div className="fadeup">
                ...
                <p className="sub-title-border-about background-color-white ">
                  ...
                  <span className="font-semibold"> tech stacks and tools</span>,
                  including
                  <span className="font-semibold">
                    {" "}
          ...
          <article className="p-6 flex gap-2 bg-white border rounded-lg shadow-sm">
            ...
            <div className="flex flex-col">
              ...
              >
                ...
                <span className="font-bold"> Management Graduate</span>, started
                his journey as a{" "}
              ...
              <h4 className="section-info_primary-text-subheading"> Socials</h4>
          ...
          <article className="p-6 flex gap-2 bg-white border rounded-lg shadow-sm">
            ...
            <div className="flex flex-col">
              ...
              >
                ...
                school, began his creative journey while pursuing Graduation and
                Chartered Accountancy.
                <span className="font-bold">
                  {" "}
                  sionate about photography, animation, and all forms of visual
                  storytelling, he poured his creativity into post-production
                  and video editing
                </span>
